    ...
    <div className="font-body text-slate-600 antialiased bg-white">
      ...
      {loadingProducts ? (
        ...
        <>
          ...
          <Modal
            isOpen={isModalOpen}
            onClose={closeHomePromo}
            showCloseButton={false}
            panelClassName="max-w-[18rem] sm:max-w-[24rem] md:max-w-[28rem]"
          >
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              <div className="flex w-full justify-end">
                <button
                  type="button"
                  onClick={closeHomePromo}
                  className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-600 shadow-[0_10px_25px_rgba(15,23,42,0.12)] transition hover:border-slate-300 hover:text-slate-900"
                ...
                >
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-slate-100 text-slate-700">
                    <Icon className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none">
                      <path
              ...
              <div className="overflow-hidden rounded-[1.75rem] bg-white shadow-[0_24px_70px_rgba(15,23,42,0.22)] ring-1 ring-slate-200/70">
                <img
                  src="/banner6.jpg"
