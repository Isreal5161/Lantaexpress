            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <form className="flex gap-2">
                  ...
                  <Button variant="primary" contentKey="cta_9" className="bg-green-600 text-white px-4 py-2 rounded-md text-sm font-bold hover:bg-green-700 transition-colors"> Subscribe </Button>
                </form>
              </div>
            </div>
