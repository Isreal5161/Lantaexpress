            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li>
                    <Link className="hover:text-white transition-colors" href="#"> Logisitcs </Link>
                  </li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <form className="flex gap-2">
                  <Input variant="text" className="bg-slate-800 border-none rounded-md px-4 py-2 text-sm w-full focus:ring-2 focus:ring-green-500" type="email" placeholder="Enter your email" />
                  <Button variant="primary" contentKey="cta_27" className="bg-green-600 text-white px-4 py-2 rounded-md text-sm font-bold hover:bg-green-700 transition-colors"> Subscribe </Button>
                </form>
              </div>
            </div>
