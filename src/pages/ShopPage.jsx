      ...
      <div className="bg-slate-50 border-b border-slate-200">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            {/* breadcrumb placeholder - keep spacing consistent with banner below */}
          </div>
          </div>
        </div>

        {/* Promotional banner (reuse BannerCarousel) placed between breadcrumb and categories */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <aside className="w-full lg:w-64 flex-shrink-0 space-y-8">
              <div className="overflow-x-auto bg-white border-b border-slate-200 py-0 -mt-3">
